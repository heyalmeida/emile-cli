...
9. **Git discipline:** implementation, documentation artifacts and closeout files are committed directly on `development`; do not switch branches, create worktrees, pull, merge or rebase as a routine SDD step (Rule 8 of `.clinerules`).
