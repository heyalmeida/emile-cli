...
| **RF-14** | Coherent terminal UI: Tokyo Night palette, boxes, slash-command autocomplete, input history and aligned multiline tool output | ✅ (continuous improvement — see [visual identity](visual-identity.md)) |
