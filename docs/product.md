...
| **RF-14** | Coherent terminal UI: Tokyo Night palette, boxes, one persistent full prompt across idle/active turns, slash-command autocomplete, keyboard navigation and multiline paste retention | ✅ (continuous improvement — see [visual identity](visual-identity.md)) |
