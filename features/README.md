...
|---------|--------|-------------|------------|
| [Terminal UI (TUI)](./terminal-ui.md) | active | `feat/ux-ui` | `specs/2026-08-25-tui-overhaul` + `2026-08-25-tui-premium` + `2026-08-25-tui-open-boxes` + `2026-08-25-prompt-multiline-fix` + `2026-08-25-dynamic-terminal-title` + `2026-09-01-turn-interrupt-queue` |
| [Agent Loop](./agent-loop.md) | active | `feat/agent-loop` | `specs/2026-08-25-project-structure` + `specs/2026-08-25-model-system` + `specs/2026-08-30-session-resilience` + `2026-09-01-turn-interrupt-queue` |
