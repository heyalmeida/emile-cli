...
### Added
- **User-global agent memory design** (`specs/2026-09-03-global-agent-memory`): approved the SDD package and ADR-0004 for a provider-independent memory of confirmed preferences, workflow and recurring corrections, including conservative candidate promotion, bounded retrieval, recoverable global storage and explicit privacy/deletion controls. Runtime implementation remains pending.
